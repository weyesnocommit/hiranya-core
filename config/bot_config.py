...
MISUNDERSTOOD_LIST = ['Huh.','HuhARraq', 'uh muuhm HUHmmm', 'BOAH', 'fuoooah,,', 'yarrab!!11', 'cools', '_    _', ':emojo3:', ':ceramic:', ':ZYCOSMOKE:', ':ookae:', 'not ubderstand', ':Amnot:']
MARKOV_SERVER_LOG_LEVEL = logging.INFO
MARKOV_PORT = '5555'
